...
from common.model import NatureModel, ImpalaModel, AttentionModel
from common.policy import CategoricalPolicy, CustomCategoricalPolicy
...
if __name__=='__main__':
    ...
    parser.add_argument('--chk_path',         type=str, default='', help='path to check point file')
    ...
    if architecture == 'nature':
        ...
        model = AttentionModel(in_channels=in_channels)
    ...
    if isinstance(action_space, gym.spaces.Discrete):
        ...
        if architecture == 'attention':
            policy = CustomCategoricalPolicy(model, recurrent, action_size)
        else:
